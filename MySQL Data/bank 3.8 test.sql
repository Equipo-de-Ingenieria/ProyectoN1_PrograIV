...
insert into Account (balance, user_id, currency_name, account_type_id, transaction_limit, is_active, current_limit) values (2000.0, '2', 'CRC', 1, 1000000, 1, 1000000);
insert into Account (balance, user_id, currency_name, account_type_id, transaction_limit, is_active, current_limit) values (0.0, '2', 'CRC', 1, 1000000, 1, 2000);
insert into Account (balance, user_id, currency_name, account_type_id, transaction_limit, is_active, current_limit) values (0.0, '2', 'USD', 1, 1000000, 1, 1000000);

insert into Account (balance, user_id, currency_name, account_type_id, transaction_limit, is_active, current_limit) values (0.0, '3', 'CRC', 1, 1000000, 1, 1000000);
insert into Account (balance, user_id, currency_name, account_type_id, transaction_limit, is_active, current_limit) values (0.0, '3', 'CRC', 1, 1000000, 1, 1000000); 
insert into Account (balance, user_id, currency_name, account_type_id, transaction_limit, is_active, current_limit) values (0.0, '3', 'USD', 1, 1000000, 1, 1000000);

insert into Account (balance, user_id, currency_name, account_type_id, transaction_limit, is_active, current_limit) values (0.0, '4', 'CRC', 1, 1000000, 1, 1000000);
insert into Account (balance, user_id, currency_name, account_type_id, transaction_limit, is_active, current_limit) values (0.0, '4', 'CRC', 1, 1000000, 1, 1000000);
insert into Account (balance, user_id, currency_name, account_type_id, transaction_limit, is_active, current_limit) values (0.0, '4', 'USD', 1, 1000000, 1, 1000000);
...
insert into Transfer (depositor_account, creditor_account, amount, `date`, detail) values (2, 3, 500, sysdate(), 'Compra de carro');
insert into Transfer (depositor_account, creditor_account, amount, `date`, detail) values (2, 3, 100, sysdate(), 'Compra de comida');
insert into Transfer (depositor_account, creditor_account, amount, `date`, detail) values (2, 3, 1000, sysdate(), 'Me dio la gana');
...
CREATE EVENT resetLimitDaily
    ON SCHEDULE
      EVERY 24 hour
        DO
update Account 
set current_limit = transaction_limit 
where transaction_limit = transaction_limit;
